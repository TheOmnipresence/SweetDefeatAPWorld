...
def create_regular_locations(world: SweetDefeatWorld) -> None:
    ...
    bottom_left_chest = SweetDefeatLocation(
    ...
    bottom_right_room.add_locations(bottom_right_room_locations, SweetDefeatLocation)

    top_left_room_locations = get_location_names_with_ids(["Top Left Room Chest"])
    top_left_room.add_locations(top_left_room_locations, SweetDefeatLocation)

    right_room_locations = get_location_names_with_ids(["Right Room Enemy Drop"])
    right_room.add_locations(right_room_locations, SweetDefeatLocation)
    ...
    if world.options.hammer:
        ...
        top_middle_room.add_locations(top_middle_room_locations, SweetDefeatLocation)
    else:
        overworld.add_locations(top_middle_room_locations, SweetDefeatLocation)
