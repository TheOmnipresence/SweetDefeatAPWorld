...
Sweet Defeat is a fast-paced speedrunning platformer game.

### Items / Locations
The items are the bubbles and coolers in every level.  
The locations are the completions of every level in each mode (except 31).
