...
def set_all_location_rules(world: SweetDefeatWorld) -> None:
    for i in ["Normal", "Invisible", "Pacifism"]:
        ...
        set_level_rule(world, i + " Level 6", lambda state: (state.has("Level 6 Bubble 5", world.player) and (state.has("Level 6 Bubble 4", world.player) or state.has("Level 6 Bubble 3", world.player))) or state.has("Level 6 Bubble 4", world.player))
        set_level_rule(world, i + " Level 7", lambda state: ((state.has("Level 7 Bubble 5", world.player) and (state.has("Level 7 Bubble 4", world.player) or state.has("Level 7 Bubble 3", world.player))) or state.has("Level 7 Bubble 4", world.player)) and state.has_all(["Level 7 Bubble 9", "Level 7 Cooler 1", "Level 7 Cooler 2"], world.player))
        set_level_rule(world, i + " Level 8", lambda state: ((state.has("Level 8 Bubble 5", world.player) and (state.has("Level 8 Bubble 4", world.player) or state.has("Level 8 Bubble 3", world.player))) or state.has("Level 8 Bubble 4", world.player)) and state.has_all(["Level 8 Bubble 9", "Level 8 Bubble 11"], world.player))
        ...
        set_level_rule(world, i + " Level 18", lambda state: state.has_all(["Level 18 Bubble 1", "Level 18 Bubble 2", "Leve 18 Bubble 3"], world.player))
    ...
    set_level_rule(world, "Node Level 6", lambda state: ((state.has("Level 6 Bubble 5", world.player) and (state.has("Level 6 Bubble 4", world.player) or state.has("Level 6 Bubble 3", world.player))) or state.has("Level 6 Bubble 4", world.player)) and state.has("Level 1 Node", world.player))
    set_level_rule(world, "Node Level 7", lambda state: ((state.has("Level 7 Bubble 5", world.player) and (state.has("Level 7 Bubble 4", world.player) or state.has("Level 7 Bubble 3", world.player))) or state.has("Level 7 Bubble 4", world.player)) and state.has_all(["Level 7 Bubble 9", "Level 7 Node"], world.player))
    set_level_rule(world, "Node Level 8", lambda state: ((state.has("Level 8 Bubble 5", world.player) and (state.has("Level 8 Bubble 4", world.player) or state.has("Level 8 Bubble 3", world.player))) or state.has("Level 8 Bubble 4", world.player)) and state.has_all(["Level 8 Bubble 9", "Level 8 Bubble 11", "Level 8 Node"], world.player))
    ...
    set_level_rule(world, "Node Level 28", lambda state: state.has_all(["Level 28 Node", "Leve 28 Cooler 1"], world.player))
    set_level_rule(world, "Node Level 29", lambda state: state.has("Level 29 Node", world.player))
    set_level_rule(world, "Node Level 30", lambda state: state.has_all(["Level 30 Node", "Leve 30 Cooler 1"], world.player))
    ...
    set_level_rule(world, "Rampage Level 6", lambda state: (state.has("Level 6 Bubble 5", world.player) and (state.has("Level 6 Bubble 4", world.player) or state.has("Level 6 Bubble 3", world.player))) or state.has("Level 6 Bubble 4", world.player))
    set_level_rule(world, "Rampage Level 7", lambda state: ((state.has("Level 7 Bubble 5", world.player) and (state.has("Level 7 Bubble 4", world.player) or state.has("Level 7 Bubble 3", world.player))) or state.has("Level 7 Bubble 4", world.player)) and state.has("Level 7 Bubble 9", world.player))
    set_level_rule(world, "Rampage Level 8", lambda state: ((state.has("Level 8 Bubble 5", world.player) and (state.has("Level 8 Bubble 4", world.player) or state.has("Level 8 Bubble 3", world.player))) or state.has("Level 8 Bubble 4", world.player)) and state.has_all(["Level 8 Bubble 9", "Level 8 Bubble 11"], world.player))
    ...
    set_level_rule(world, "Cool Level 6", lambda state: ((state.has("Level 6 Bubble 5", world.player) and (state.has("Level 6 Bubble 4", world.player) or state.has("Level 6 Bubble 3", world.player))) or state.has("Level 6 Bubble 4", world.player)) and state.has("Level 6 Cooler 1", world.player))
    set_level_rule(world, "Cool Level 7", lambda state: ((state.has("Level 7 Bubble 5", world.player) and (state.has("Level 7 Bubble 4", world.player) or state.has("Level 7 Bubble 3", world.player))) or state.has("Level 7 Bubble 4", world.player)) and state.has_all(["Level 7 Bubble 9", "Level 7 Cooler 1", "Level 7 Cooler 2"], world.player))
    set_level_rule(world, "Cool Level 8", lambda state: ((state.has("Level 8 Bubble 5", world.player) and (state.has("Level 8 Bubble 4", world.player) or state.has("Level 8 Bubble 3", world.player))) or state.has("Level 8 Bubble 4", world.player)) and state.has_all(["Level 8 Bubble 9", "Level 8 Cooler 1", "Level 8 Cooler 2"], world.player))
    ...
    set_level_rule(world, "Easier Level 5", lambda state: state.has_from_list_unique(["Level 5 Bubble 1", "Level 5 Bubble 2", "Level 5 Bubble 3", "Level 5 Bubble 4"], world.player, 3) and state.has_from_list_unique(["Level 5 Cooler 1", "Level 5 Cooler 2", "Level 5 Cooler 3"], world.player, 2)) #TODO
    set_level_rule(world, "Easier Level 6", lambda state: (state.has("Level 6 Bubble 5", world.player) and (state.has("Level 6 Bubble 4", world.player) or state.has("Level 6 Bubble 3", world.player))) or state.has("Level 6 Bubble 4", world.player))
    ...
    set_level_rule(world, "Easier Level 8", lambda state: ((state.has("Level 8 Bubble 5", world.player) and (state.has("Level 8 Bubble 4", world.player) or state.has("Level 8 Bubble 3", world.player))) or state.has("Level 8 Bubble 4", world.player)) and state.has("Level 8 Bubble 9", world.player))
    ...
    set_level_rule(world, "One Level 6", lambda state: (state.has("Level 6 Bubble 5", world.player) and (state.has("Level 6 Bubble 4", world.player) or state.has("Level 6 Bubble 3", world.player))) or state.has("Level 6 Bubble 4", world.player))
    ...
    set_level_rule(world, "One Level 8", lambda state: (state.has("Level 8 Bubble 5", world.player) and (state.has("Level 8 Bubble 4", world.player) or state.has("Level 8 Bubble 3", world.player))) or state.has("Level 8 Bubble 4", world.player))
