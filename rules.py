...
def set_all_location_rules(world: SweetDefeatWorld) -> None:
    for i in ["Normal", "Invisible", "Pacifism"]:
        ...
        set_level_rule(world, i + " Level 6", lambda state: (state.has("Level 6 Bubble 5", world.player) and (state.has("Level 6 Bubble 4", world.player) or state.has("Level 6 Bubble 3", world.player))) or state.has("Level 6 Bubble 5", world.player))
        set_level_rule(world, i + " Level 7", lambda state: ((state.has("Level 7 Bubble 5", world.player) and (state.has("Level 7 Bubble 4", world.player) or state.has("Level 7 Bubble 3", world.player))) or state.has("Level 7 Bubble 5", world.player)) and state.has_all(["Level 7 Bubble 9", "Level 7 Cooler 1", "Level 7 Cooler 2"], world.player))
        set_level_rule(world, i + " Level 8", lambda state: ((state.has("Level 8 Bubble 5", world.player) and (state.has("Level 8 Bubble 4", world.player) or state.has("Level 8 Bubble 3", world.player))) or state.has("Level 8 Bubble 5", world.player)) and state.has_all(["Level 8 Bubble 9", "Level 8 Bubble 11"], world.player))
    ...
    set_level_rule(world, "Rampage Level 6", lambda state: (state.has("Level 6 Bubble 5", world.player) and (state.has("Level 6 Bubble 4", world.player) or state.has("Level 6 Bubble 3", world.player))) or state.has("Level 6 Bubble 5", world.player))
    set_level_rule(world, "Rampage Level 7", lambda state: ((state.has("Level 7 Bubble 5", world.player) and (state.has("Level 7 Bubble 4", world.player) or state.has("Level 7 Bubble 3", world.player))) or state.has("Level 7 Bubble 5", world.player)) and state.has("Level 7 Bubble 9", world.player))
    set_level_rule(world, "Rampage Level 8", lambda state: ((state.has("Level 8 Bubble 5", world.player) and (state.has("Level 8 Bubble 4", world.player) or state.has("Level 8 Bubble 3", world.player))) or state.has("Level 8 Bubble 5", world.player)) and state.has_all(["Level 8 Bubble 9", "Level 8 Bubble 11"], world.player))
    ...
    set_level_rule(world, "Cool Level 6", lambda state: ((state.has("Level 6 Bubble 5", world.player) and (state.has("Level 6 Bubble 4", world.player) or state.has("Level 6 Bubble 3", world.player))) or state.has("Level 6 Bubble 5", world.player)) and state.has("Level 6 Cooler 1", world.player))
    set_level_rule(world, "Cool Level 7", lambda state: ((state.has("Level 7 Bubble 5", world.player) and (state.has("Level 7 Bubble 4", world.player) or state.has("Level 7 Bubble 3", world.player))) or state.has("Level 7 Bubble 5", world.player)) and state.has_all(["Level 7 Bubble 9", "Level 7 Cooler 1", "Level 7 Cooler 2"], world.player))
    set_level_rule(world, "Cool Level 8", lambda state: ((state.has("Level 8 Bubble 5", world.player) and (state.has("Level 8 Bubble 4", world.player) or state.has("Level 8 Bubble 3", world.player))) or state.has("Level 8 Bubble 5", world.player)) and state.has_all(["Level 8 Bubble 9", "Level 8 Cooler 1", "Level 8 Cooler 2"], world.player))
    ...
    set_level_rule(world, "Easier Level 6", lambda state: (state.has("Level 6 Bubble 5", world.player) and (state.has("Level 6 Bubble 4", world.player) or state.has("Level 6 Bubble 3", world.player))) or state.has("Level 6 Bubble 5", world.player))
    set_level_rule(world, "Easier Level 7", lambda state: ((state.has("Level 7 Bubble 5", world.player) and (state.has("Level 7 Bubble 4", world.player) or state.has("Level 7 Bubble 3", world.player))) or state.has("Level 7 Bubble 5", world.player)) and state.has("Level 7 Bubble 9", world.player) and state.has_any(["Level 7 Cooler 1", "Level 7 Cooler 2"], world.player))
    set_level_rule(world, "Easier Level 8", lambda state: ((state.has("Level 8 Bubble 5", world.player) and (state.has("Level 8 Bubble 4", world.player) or state.has("Level 8 Bubble 3", world.player))) or state.has("Level 8 Bubble 5", world.player)) and state.has("Level 8 Bubble 9", world.player))
    ...
    set_level_rule(world, "One Level 6", lambda state: (state.has("Level 6 Bubble 5", world.player) and (state.has("Level 6 Bubble 4", world.player) or state.has("Level 6 Bubble 3", world.player))) or state.has("Level 6 Bubble 5", world.player))
    ...
    set_level_rule(world, "One Level 8", lambda state: (state.has("Level 8 Bubble 5", world.player) and (state.has("Level 8 Bubble 4", world.player) or state.has("Level 8 Bubble 3", world.player))) or state.has("Level 8 Bubble 5", world.player))
